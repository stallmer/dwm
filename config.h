...
static const char *fonts[]          = { "Hack Nerd Font Mono:size=12", "NotoColorEmoji:size=12:antialias=true:autohint=true" };
...
#define MEH Mod1Mask|ShiftMask|ControlMask
#define HYPER Mod1Mask|ShiftMask|ControlMask|Mod4Mask
...
static const Key keys[] = {
	...
	{ 0, XF86XK_AudioRaiseVolume, 	spawn, 		SHCMD("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+; kill -42 $(pidof dwmblocks)") },
